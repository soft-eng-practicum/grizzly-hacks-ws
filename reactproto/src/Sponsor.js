...
const sponsor = () => (
  <Segment inverted>
    <Segment
      inverted
      style={{ padding: "2em 0em", margin: "-29px" }}
      vertical
      id="sponsors"
      class="zoom"
    >
      {/* Header text */}
      <Fade top>
        <Header style={{ color: "white", marginTop: 0 }} size="huge">
          Sponsors
        </Header>
      </Fade>
      ...
      <div>
        <Fade>
          <a
            target="_blank"
            href="https://careers.mcdonalds.com/main/us/corporate/career-trackshttps://www.mcdonalds.com/us/en-us.html"
          >
